...
interface CarouselImageProps {
    ...
    essential?: boolean;
    category?: boolean;
    data: dataType[]; // Replace `any[]` with the specific type of your data
}
                                    ...
                                    >
                                        <span className="flex w-full justify-between">
                                            ...
                                            >
                                                ...
                                                >
                                                    <Image src={data[index].icon || "/assets/best-nike-1.svg"} alt={data[index].title || "alt"} width={50} height={50} />
                                                    <p
                                            ...
                                            <span>
                                                <Image src={data[index].heroIcon || "/assets/best-nike-2.svg"} alt={data[index].title || "alt"} width={400} height={400} />
                                            </span>
                                        </span>
                                    </CardContent>
                                </Card>
                                ...
                                > */}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <Image src={_.image || "/assets/best-nike-2.svg"} alt={_.title || "alt"} width={400} height={300} className="z-10" />
                                            </span>
                                ...
                                > */}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <Image
                                                    src={_?.icon || '/assets/best-nike-1.svg'}
                                                    alt={_.title || "alt"}
                                                    // width={100}
                                                    // height={100}
