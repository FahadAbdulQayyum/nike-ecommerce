...
const ContactUsComponent = () => {
    ...
    return (
        <div className="flex p-standardSize">
            <div className="w-[75%] border-r flex flex-col items-center space-y-4">
                <h1 className="uppercase font-bold text-xl">Get Help</h1>
                <span className="flex justify-between border rounded p-2 w-[40%] text-sm items-center">
            ...
            <div className="w-[25%] flex flex-col justify-center items-center px-2">
